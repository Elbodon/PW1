...
public class UsuarioDAO {
	...
	public void criarUsuario(Usuario usuario) throws SQLException {
		PreparedStatement statement = this.conexao.prepareStatement("INSERT INTO usuarios (primeiroNome, ultimoNome, datanascimento, genero, " +
				"telefone, senha, email, cidade, pais) VALUES (?,?,?,?,?,?,?,?,?) ");
